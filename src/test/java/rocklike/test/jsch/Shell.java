...
public class Shell {
	public static void main(String[] arg) {
		...
		try {
			...
			/*
			 * // a hack for MS-DOS prompt on Windows. channel.setInputStream(new FilterInputStream(System.in){ public int read(byte[] b,
			 * int off, int len)throws IOException{ return in.read(b, off, (len>1024?1024:len)); } });
			 */
